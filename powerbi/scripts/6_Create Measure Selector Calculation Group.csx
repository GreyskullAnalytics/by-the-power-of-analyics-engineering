...
string calcGroupName = Interaction.InputBox("Provide a name for your Calculation Group", "Calculation Group Name", "_Measure Selector", 740, 400);
...
if (!Model.Tables.Contains(calcGroupName)) {
  ...
  cg.Description = "Contains dynamic measures and a column called " + columnName + ". The contents of the dynamic measure can be controlled by selecting values from " + columnName + ".";
};
